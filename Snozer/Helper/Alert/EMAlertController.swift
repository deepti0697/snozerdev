...
//    alertView.layer.masksToBounds = false
  ...
  internal var titleLabel: UILabel = {
    ...
    internal var lineUnderTitle: UILabel = {
      let label = UILabel()
      label.translatesAutoresizingMaskIntoConstraints = false
        label.backgroundColor = UIColor(red: 185.0/255, green: 185.0/255, blue: 185.0/255, alpha: 1);
      return label
    }()
...
extension EMAlertController {
  ...
  internal func addConstraits() {
    ...
    alertView.addSubview(lineUnderTitle)
    ...
    imageView.topAnchor.constraint(equalTo: alertView.topAnchor, constant: 4).isActive = true
    ...
    // lineUnderTitle Constraints
    lineUnderTitle.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 10).isActive = true
    lineUnderTitle.leadingAnchor.constraint(equalTo: alertView.leadingAnchor, constant: 0).isActive = true
    lineUnderTitle.trailingAnchor.constraint(equalTo: alertView.trailingAnchor, constant: 0).isActive = true
    lineUnderTitle.heightAnchor.constraint(equalToConstant: 1).isActive = true
    lineUnderTitle.sizeToFit()
    
    // messageLabel Constraints
    messageTextView.topAnchor.constraint(equalTo: lineUnderTitle.bottomAnchor, constant: 5).isActive = true
